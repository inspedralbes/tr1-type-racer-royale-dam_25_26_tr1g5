  ...
  <template>
    <v-app>
        ...
        <v-container class="py-8" fluid>
          ...
          <v-row justify="center">
            <v-col v-for="exercise in filteredExercises" :key="exercise.id" cols="12" sm="6" md="4" lg="3">
              <v-card class="exercise-card" elevation="2" height="200" @click="goToExercise(exercise)" hover>
      ...
      <v-footer color="#FF6600" class="text-center d-flex align-center justify-center" height="60"
        ...
        <v-img src="/fitcamicon.png" alt="FitCam" contain max-height="96" max-width="96" />
      </v-footer>
      ...
      <v-dialog v-model="loginDialog" max-width="400">
        <v-card>
          ...
          <v-card-text class="pb-2">
            <v-text-field v-model="tempName" label="Nom d'usuari" variant="outlined" density="comfortable"
              hide-details />
          </v-card-text>
